...
TASK RULES:
1. Limit SELECT queries to 10 result max with ORDERED by created_at DESC
...
Table schema: id, title, description, status(pending/in_progress/completed), created at.
